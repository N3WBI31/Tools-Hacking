...
echo $merah "+++[]============================[]+++"
sleep 0.2
echo $daun  "     8.HackAkunFF By RelGanz"
echo $merah "+++[]============================[]+++"
sleep 0.2
...
git clone https://github.com/NE3WBI1/BruteFace
cd BruteFacd
python2 Brute.py
exit
fi
...
clear
echo $tai
cowsay -f kiss.cow "./Zarel.IT"
echo 	
echo			
echo	$cyyan "      Code By "$merah"./Zarel.IT"
echo
echo
echo
echo $daun
...
clear
txt
Sorry Tod Sc Nya Prem Kalau Mau Beli Chat 
088210982908
fi
...
echo $merah "[]=============================[]"
echo $merah "[]"$daun" Author    : ./Zarel.IT   "$merah"[]"
echo $merah "[]"$daun" Nama      : RelGanz      "$merah"[]"
echo $merah "[]"$daun" Panggilan : Zarell.      "$merah"[]"
echo $merah "[]"$daun" Umur      : - Smp        "$merah"[]"
echo $merah "[]"$daun" No Telp   : 088210982908 "$merah"[]"
echo $merah "[]"$daun" Youtube   : RelGanz   "$merah"[]"
echo $merah "[]=============================[]"
echo
echo $merah "[]=============================[]"
...
echo $merah "[]"$daun" code       : RelGanz         "$merah"[]"
echo $merah "[]=============================[] "
echo
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo $merah "[]"$daun"               MyGrup              "$merah"[]"
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo $merah "[] "$tai"1.Bekasi Cyber Team [ admin ]          "$merah"    []"
echo $merah "[] "$tai"2.Bekasi Cyber Exploiter         "$merah"    []"
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo
echo
